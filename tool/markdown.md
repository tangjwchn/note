...
Markdown 是一种轻量级标记语言，由 John Gruber 和 Aaron Swartz 于 2004 年创建，皆在让人们用易读易写的纯文本格式编写文档。常用的标签大约只有10个左右，包含标题、段落、换行、强调、引用、有序列表、无序列表、代码块、分隔线、简单表格等。

**Markdown 是让写作回归内容本身，同时又能生成专业排版的“极简语言”**。
